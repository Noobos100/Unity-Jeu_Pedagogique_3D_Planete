...
if (isset($_SESSION['loggedin'])) {
    return '    
        ...
        <button class="sidebar-button" onclick="window.open(\'https://jeupedagogique.pq.lu/manuals/Manuel_dutilisation_dashboard.pdf\', \'_blank\')">Manuel du jeu</button>
    ...
    return ' 
        ...
        <button class="sidebar-button" onclick="window.open(\'https://jeupedagogique.pq.lu/manuals/Manuel_dutilisation_windows.pdf\', \'_blank\')">Manuel du dashboard</button>';
}
